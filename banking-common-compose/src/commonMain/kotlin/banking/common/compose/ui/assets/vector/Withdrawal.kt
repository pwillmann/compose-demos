...
public val VectorAssets.Withdrawal: VectorAsset
    get() {
        if (_icWithdrawal != null) {
            return _icWithdrawal!!
        }
        _icWithdrawal = VectorAssetBuilder(
            name = "IcWithdrawal", defaultWidth = 72.0.dp,
            defaultHeight = 72.0.dp, viewportWidth = 72.0f, viewportHeight = 72.0f
        ).apply {
            path(
                ...
                moveToRelative(10.347f, 6.7106f)
            ...
            path(
                ...
                moveToRelative(16.7666f, 32.2749f)
            ...
            path(
                ...
                moveToRelative(34.0328f, 20.3613f)
            ...
            path(
                ...
                moveToRelative(16.7666f, 52.3884f)
            ...
            path(
                ...
                moveToRelative(16.7666f, 59.2206f)
...
private var _icWithdrawal: VectorAsset? = null
