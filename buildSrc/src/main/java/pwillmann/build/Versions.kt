...
object Versions {
    ...
    const val jetBrainsCompose = "0.1.0-build113"

    // androidX versions
    const val androidxAnnotation = "1.0.0"
    const val dynamicAnimationKtx = "1.0.0-alpha01"
    ...
    const val testJunit = "1.1.2-rc01"
    const val viewPager2 = "1.0.0"
    const val camerax = "1.0.0-beta06"
    const val preferences = "1.1.1"
    const val fragment = "1.2.5"
    const val activity = "1.1.0"
    const val camerax_view = "1.0.0-alpha13"
    ...
    const val flipper = "0.60.0"
    const val beagle = "2.0.5"
